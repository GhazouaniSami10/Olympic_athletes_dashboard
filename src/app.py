...
tab_selected_style = {'border': 'none', 'borderBottom': '3px solid #EE334E',  'padding': '7px', 'fontWeight': 'bold', 'color': 'black', 'background': '#3178FC'} ##FCB131  #3178FC

app.layout = html.Div([
        html.Div('About', id = 'help_btn'),
        dbc.Tooltip(
                    children = [html.H3('Tassahil Center for Intelligent Solutions'), 
                                html.Hr(), 
                                'This is a dashboard which allows you to observe the distribution of athlete profiles based on their sports, competition years, competition seasons and nationalities provided by Tassahil Center for Intelligent Solutions.', html.Br(), html.Br(),
        ...
        html.Div([
            html.H1("Olympics Athletes Data Visualization",
                    style = {'color': '#87CEEB', 'text-align': 'left', 'padding': '0px 0px 0px 20px', 'margin-bottom': '-10px'}),
            html.H4("Insights for Olympic Athlete Information since 1896", 
                    style = {'color': '#87CEEB', 'text-align': 'left', 'padding': '0px 0px 10px 20px'}),
        ], id = 'header'),
        # Main Container Div
        html.Div([
            ...
            html.Div([
                ...
                html.Div([
                    html.H5("Select Years"),
                    dcc.RangeSlider(
                        min = 1896, max = 2016,
                        marks = {i: {'label': f'{i+4}', 'style': {'transform': 'rotate(90deg)', 'color': '#87CEEB'}} for i in range(1896, 2016, 8)},
                        id = 'year_range',
                        value = [1896, 2016],
                ...
                ], style = {'width': '100%', 'flex-grow': '1', 'color': '#87CEEB'}),
                html.Div([
                ...
                dcc.Tabs([
                    ...
                    dcc.Tab(label='Data Table', children = [
                        ...
                        dash_table.DataTable(data=df.sample(50).to_dict('records'), 
                                    ...
                                    style_header = {'color': '#87CEEB', 'backgroundColor': '#322c4a', 'border': '0px solid #87CEEB', 'fontWeight': 'bold', 'textAlign': 'left'},
                                    style_data = {'backgroundColor': '#96293F', 'color': '#87CEEB', 'height': 'auto', 'whiteSpace': 'normal', 'font-size': '10.5px'},
...
styling_template = {'title': {'font': {'size': 21, 'family': 'helvetica', 'color': '#87CEEB'}, 'x': 0,
                        'xref':'paper', 'y': 1, 'yanchor': 'bottom', 'yref':'paper', 'pad':{'b': 20}},
                'legend': {'font': {'color': '#87CEEB'}},
...
map_styles = {
    ...
    'geo': {'bgcolor': 'rgba(0,0,0,0)',
            ...
            'lakecolor': '#97c7f7'},
    'coloraxis': {
        'colorbar': {'title': {'font': {'color': '#87CEEB', 'family': 'system-ui,-apple-system,"Segoe UI"'}},
                    'tickfont': {'color': '#87CEEB', 'family': 'system-ui,-apple-system,"Segoe UI"'}}

    },
    'sliders': [{'font': {'color': '#87CEEB'}, 'tickcolor': '#87CEEB', 'pad': {'t': 0}}],
    'updatemenus': [{'font': {'color': '#87CEEB'}, 'pad': {'t': 10}}]
}
...
def update_graphs(year_range, sport, country, medals, season, select):
    ...
    title1 = 'Athlete Heights Distribution'
    title2 = 'Athlete Ages Distribution'
    title3 = 'Athlete Weights Distribution'
...
def update_map(year_range, sport, country, medals, season, animation):
    ...
    if animation=="Animate":
        ...
        map = px.choropleth(grouped,
                ...
                color_continuous_scale=['#87CEEB', '#00A651']
                )
